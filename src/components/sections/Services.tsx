          ...
          {SERVICES.map((service) => (
            <motion.div key={service.title} variants={cardVariants}>
              <Card className="h-full text-center shadow-sm hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
                  <div className="mx-auto bg-primary-blue/10 rounded-full p-4 w-fit mb-4">
                    <service.icon className="h-8 w-8 text-primary-blue" />
                  </div>
                  <CardTitle className="text-xl font-semibold text-brand-text">
                    {service.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <a
                    href="#"
                    className="font-semibold text-primary-blue hover:underline inline-flex items-center"
                  >
