        ...
        >
          {TESTIMONIALS.map((testimonial, index) => (
            <motion.div key={index} variants={cardVariants}>
              <Card className="h-full glass overflow-hidden bg-brand-light/50 backdrop-blur-lg border border-gray-200/50">
                <CardContent className="p-8">
                  ...
                  <footer className="font-semibold text-brand-text">
                    {testimonial.name}
